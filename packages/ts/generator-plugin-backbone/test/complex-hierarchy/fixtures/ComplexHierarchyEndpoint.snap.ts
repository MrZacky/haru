...
async function getModel_1(init?: EndpointRequestInit_1): Promise<ComplexHierarchyModel_1 | undefined> { return client_1.call("POST", "/ComplexHierarchyEndpoint/getModel", {}, init); }
