...
/**
 * The controller that is responsible for processing endpoint requests. Each
 * class that is annotated with {@link Endpoint} or {@link BrowserCallable} gets
 * its public methods exposed so that those can be triggered by a correct POST
 * request, including the methods inherited from the other classes, excluding
...
public class EndpointController {
    ...
    /**
     * Captures and processes the endpoint requests.
     * <p>
    ...
    /**
     * Captures and processes the multipart endpoint requests. They are used
