...
public class CsrfChecker {
    ...
    boolean isSpringCsrfTokenPresent(ServletRequest request) {
        // Spring Security stores the CsrfToken as a request attribute
        return request.getAttribute(CsrfToken.class.getName()) != null
                || request.getAttribute("_csrf") != null;
    }

    private static Logger getLogger() {
        return LoggerFactory.getLogger(CsrfChecker.class);
    }
